...
class TrainRetrievalDataset(torch.utils.data.Dataset):
    def __init__(self, model_checkpoint, dataset, p_tokenizer, q_tokenizer):
    ...
    def __getitem__(self, idx):
        ...
        if self.model_checkpoint != 'xlm-roberta-large':
        ...
        if self.model_checkpoint == 'xlm-roberta-large':
            return p_input_ids_list, p_attention_mask_list, q_input_ids, q_attention_mask, target
        else:
