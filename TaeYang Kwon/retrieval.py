...
class SparseRetrieval:
    def __init__(self, tokenize_fn, data_path="../input/data/data", context_path="wikipedia_documents.json"):
    ...
    def get_sparse_embedding(self, make_new_sparse_retrieval):
        # Pickle save.
        pickle_name = f"sparse_embedding.bin"
        tfidfv_name = f"tfidv.bin"
        emd_path = os.path.join(self.data_path, pickle_name)
        tfidfv_path = os.path.join(self.data_path, tfidfv_name)
        if not make_new_sparse_retrieval and os.path.isfile(emd_path) and os.path.isfile(tfidfv_path):
            ...
            print(type(self.tfidfv))
            print(self.p_embedding.shape)
            # print(self.tfidfv.shape)
